...
@Component({
  ...
  styleUrls: ['./practical-lessons.component.scss'],
})
export class PracticalLessonsComponent implements OnInit {
  ...
  public practicalLayerSpinner: string = 'practicalLayerSpinner';
  ...
  ngOnInit(): void {
    this.spinnerService.showSpinner(this.practicalLayerSpinner);
  ...
  getAll() {
    this.lessonService
      ...
      .subscribe((laboratories) => {
        ...
        this.spinnerService.hideSpinner(this.practicalLayerSpinner);
      });
