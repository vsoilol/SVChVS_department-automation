...
namespace DepartmentAutomation.Application.Common.Extensions
{
    public static class IQueryableExtensions
    {
        ...
        public static IOrderedQueryable<T> OrderByDynamic<T>(this IQueryable<T> query, string propertyName,
            Order sortDirection, IComparer<object> comparer = null)
        {
            return CallOrderedQueryable(query,
                sortDirection == Order.Desc ? "OrderByDescending" : "OrderBy", propertyName, comparer);
        }
