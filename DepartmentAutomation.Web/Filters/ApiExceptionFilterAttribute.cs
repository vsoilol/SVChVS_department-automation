...
using DepartmentAutomation.Web.ResponseProblemDetails;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.Filters;

namespace DepartmentAutomation.Web.Filters
{
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        private void HandleFluentValidationException(ExceptionContext context)
        {
            ...
            var details = new FluentValidationProblemDetails(exception.Errors)
            {
